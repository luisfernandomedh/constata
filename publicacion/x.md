...
## Versión principal (248 caracteres)
...
## Variante corta (177 caracteres)

«Banco Pichincha: consumo de $340, bloquee aquí»
...
## Hilo, por si quieres desarrollarlo
...
**4/** Conoce instituciones de acá: Pichincha, Guayaquil, Produbanco, SRI, IESS, Claro, CNT. Eso es lo que ninguna herramienta gringa tiene.

**5/** Y todo corre en tu navegador. No hay servidor, no hay cuenta. Desconecta el internet y sigue funcionando. Esa no es una promesa, es cómo está construido.
